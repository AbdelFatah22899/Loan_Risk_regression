...
def pre_train(data):
    ...
    data['DebtToIncomeRatio'] = data.loc[:, 'DebtToIncomeRatio'].fillna(value=value,
                                                                        inplace=False)
...
#poly_features = pickle.load(open(('poly_features.sav'), 'rb'))
...
#poly_model = pickle.load(open(('poly_model.sav'), 'rb'))
